...
int main() {
	...
	auto material_left = make_unique<dielectric>(1.50);
	auto material_bubble = make_unique<dielectric>(1.00 / 1.50);
	...
	world.add(make_unique<sphere>(point3(-1.0, 0.0, -1.0), 0.4, std::move(material_bubble)));
